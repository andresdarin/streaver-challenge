...
export const metadata: Metadata = {
    title: "Posts | X-plorer",
    description: "Check out the most interesting posts and daily discoveries.",
};
...
export default function Posts() {
    ...
    return (
        <>
            <Head>
                <title>Posts | X-plorer</title>
                <meta
                    name="description"
                    content="Check out the most interesting posts and daily discoveries."
                />
            </Head>
